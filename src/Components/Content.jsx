      ...
      <div className='columns is-centered'>
        <div className='column'>
          ...
          viewBox="0 0 512 512" data-fa-i2svg="">
            ...
            <p>Me gusta codificar todo el funcionamiento de atras, para dar vida a las consultas de la pagina.</p>
          
            <p class="list-title has-text-primary has-text-weight-normal">Conocimiento:</p>
            <ul className='p-text'>
                <li>Javascript </li>
                <li>Node Js</li>
                <li>MongoDB</li>
...
<section class="section projects is-medium is-white has-text-centered">
  ...
  <img class="is-rounded " src={python}/>
</figure> Python</li>
                      <li>  <figure class="image is-48x48 imagen">
  <img class="is-rounded" src={django}/>
</figure> Django</li>
  ...
  <img class="is-rounded" src={reactlogo}/>
                    ...
                    <a class="button is-primary is-outlined is-rounded " href="https://owlypragh.vercel.app/inicio" target="_blank" >Visitar</a>
                  </figcaption>
              </figure>
          </div>
