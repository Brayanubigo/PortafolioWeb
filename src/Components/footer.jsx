...
function footer() {
  return (
    <footer className="section is-primary is-small has-text-centered">
     ...
     <h1 className="title is-size-4-touch has-text-weight-normal ">Viviendo, aprendiendo y subiendo de nivel cada dia. </h1>
     </div>
    </div>
    <div className="social-icons">
        <p className="field">
            <a className="button is-medium" href="https://www.linkedin.com/in/brayan-alejandro-ubillo-godoy-47b265235/" target="_blank">
                <span className="icon is-small"> 
                <FaLinkedinIn/>
                </span>
            </a>
            <a className="button is-medium" href="https://twitter.com/BrayanUbillo" target="_blank">
                <span className="icon is-small"> 
                <FaTwitter/></span>
            </a>
        </p>
